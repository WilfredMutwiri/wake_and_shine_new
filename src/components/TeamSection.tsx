  ...
  const teamMembers = [
    {
      ...
      image: "https://wakeandshineshg.netlify.app/public/images/WhatsApp%20Image%202023-11-17%20at%208.57.08%20AM%20(1).webp"
    },
    {
      name: "William Mutegi Zachary",
      position: "Secretary",
      phone: "+254 706 367677",
      image: "https://wakeandshineshg.netlify.app/public/images/WhatsApp%20Image%202023-11-25%20at%209.43.19%20AM.webp"
    },
    {
      name: "Joel Munene Kibaara",
      position: "Treasurer",
      phone: "+254 714 938 280",
      image: "https://wakeandshineshg.netlify.app/public/images/WhatsApp%20Image%202023-11-17%20at%208.57.07%20AM%20(1).webp"
    },
    {
      name: "David Mwendwa Mutugi",
      position: "Organizing Secretary",
      phone: "+254 740 713 075",
      image: "https://wakeandshineshg.netlify.app/public/images/WhatsApp%20Image%202023-11-17%20at%208.57.09%20AM%20(1).webp"
    },
    {
      name: "Haron Mutheti Muturi",
      position: "Member",
      phone: "+254 795 171 596",
      image: "https://wakeandshineshg.netlify.app/public/images/WhatsApp%20Image%202023-11-26%20at%209.54.46%20AM.webp"
    },
    {
      name: "Stella Njagi",
      position: "Member",
      phone: "+254 742 054 026",
      image: "https://wakeandshineshg.netlify.app/public/images/WhatsApp%20Image%202023-11-26%20at%2012.27.51%20PM.webp"
    },
    {
      name: "Peter Mutembei",
      position: "Member",
      phone: "+254 704 908 310",
      image: "https://wakeandshineshg.netlify.app/public/images/WhatsApp%20Image%202023-11-28%20at%2011.46.37%20PM%20(1).webp"
    },
    {
      name: "Peter Kimathi",
      position: "Member",
      phone: "+254 794 754 724",
      image: "https://wakeandshineshg.netlify.app/public/images/IMG-20231216-WA0029.webp"
    },
    {
      name: "Kenneth Karani Njagi",
      position: "Member",
      phone: "+254 743 837 873",
      image: "https://wakeandshineshg.netlify.app/public/images/WhatsApp%20Image%202024-01-16%20at%208.11.08%20AM%20(1).webp"
    }
  ];

  const getPositionColor = (position: string) => {
    if (position.includes("Chairperson")) return "bg-primary text-primary-foreground";
    if (position.includes("Secretary")) return "bg-secondary text-secondary-foreground";
    if (position.includes("Treasurer")) return "bg-tertiary text-tertiary-foreground";
            ...
            <Card key={index} className="group shadow-custom-md hover:shadow-custom-lg transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <div className={`px-3 py-1 rounded-full text-xs font-medium ${getPositionColor(member.position)}`}>
                    {member.position === "Member" ? "Team Member" : member.position}
                  </div>
                </div>
              </div>
        ...
        <div className="text-center mt-12 font-poppins">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Want to know more about our membership and all other members in general? 
              Get in touch with us today and be part of our growing community.
            </p>
